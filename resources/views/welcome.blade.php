      ...
      <div class="row">
        ...
        <div class="col-lg-3 col-xs-6">
          ...
          <select name="limit" id="myselect">
              <option value="today_sales" {{ ($limit == today_sales) ? 'selected' : '' }}>Today Sales</option>
              <option value="weekly_sales" {{ ($limit == weekly_sales) ? 'selected' : '' }}>Weekly Sales</option>
              <option value="monthly_sales" {{ ($limit == monthly_sales) ? 'selected' : '' }}>Monthly Sales</option>
          </select>
        </div>
      </form>
            <a href="#" class="small-box-footer">More info <i class="fa fa-arrow-circle-right"></i></a>
